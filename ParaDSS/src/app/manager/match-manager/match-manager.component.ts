...
export class MatchManagerComponent extends SystemManager implements OnInit 
{
      ...
      private router: Router) 
  {
    ...
    for(this.iterator = this.tournamentSelected.iterator() ; this.iterator.hasNext() ; this.iterator.next()) {
      this.matchs.push(this.iterator.current());
    }
  }
